...
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="<?= site_url('students/documents/required') ?>" class="btn btn-sm btn-outline-primary me-2">
                <i class="fas fa-exclamation-triangle"></i> Obrigatórios
            </a>
            <a href="<?= site_url('students/documents/archive') ?>" class="btn btn-sm btn-outline-secondary">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm">
                                        <a href="<?= site_url('students/documents/view/' . $doc->id) ?>" 
                                           class="btn btn-outline-info" target="_blank" title="Visualizar">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="<?= site_url('students/documents/download/' . $doc->id) ?>" 
                                           class="btn btn-outline-success" title="Download">
                                            <i class="fas fa-download"></i>
                                        </a>
                                        <?php if ($doc->is_verified == 0): ?>
                                            <a href="<?= site_url('students/documents/delete/' . $doc->id) ?>" 
...
document.getElementById('document_file').addEventListener('change', function() {
    ...
    const selectedType = document.getElementById('document_type').selectedOptions[0];
    const maxSize = (selectedType.dataset.maxsize || 5120) * 1024; // converter para bytes
