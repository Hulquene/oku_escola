...
<div class="card border-0 shadow-sm mb-4">
    ...
    <div class="card-body">
        <form action="<?= site_url('teachers/documents/request') ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="format" name="format" required>
                        ...
                        <option value="ambos">Digital + Impresso</option>
                    </select>
                </div>
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="delivery_method" name="delivery_method" required>
                        <option value="retirar">Retirar na Escola</option>
            ...
            <div class="row g-3 mt-2">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" id="purpose" name="purpose" rows="2" 
                              placeholder="Ex: Para apresentar no local de trabalho, para concurso, etc." required></textarea>
                </div>
            </div>
            
            <div class="row g-3 mt-2" id="address-field" style="display: none;">
                <div class="col-md-12">
                        ...
                        <?php foreach ($requests as $req): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= site_url('teachers/documents/request/' . $req->id) ?>" 
                                       class="btn btn-sm btn-outline-success" title="Ver Detalhes">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <?php if ($req->status == 'pending'): ?>
                                        <a href="<?= site_url('teachers/documents/request/cancel/' . $req->id) ?>" 
