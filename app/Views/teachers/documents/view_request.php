            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-white-50 mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('teachers/documents/requests') ?>" class="text-white">Solicitações</a></li>
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <?php if ($request->status == 'pending'): ?>
                    <a href="<?= site_url('teachers/documents/request/cancel/' . $request->id) ?>" 
                ...
                <?php if ($request->status == 'ready' && $request->format != 'impresso'): ?>
                    <a href="#" class="btn btn-outline-success w-100 mt-2" data-bs-toggle="modal" data-bs-target="#downloadModal">
                        <i class="fas fa-download me-2"></i> Download
                    </a>
                <?php endif; ?>
                
                <a href="<?= site_url('teachers/documents/requests') ?>" class="btn btn-outline-secondary w-100 mt-2">
...
<div class="modal fade" id="paymentModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= site_url('teachers/documents/payment/' . $request->id) ?>" method="post">
                <?= csrf_field() ?>
...
<div class="modal fade" id="downloadModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Documentos disponíveis para download:</p>
                <div class="list-group">
                    <?php foreach ($generatedDocs ?? [] as $doc): ?>
                        <a href="<?= site_url('teachers/documents/download-generated/' . $doc->id) ?>" 
