<?php
// app/Views/teachers/layouts/header.php
...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
    <div class="container-fluid">
        ...
        <a class="navbar-brand ms-2" href="<?= site_url('teachers/dashboard') ?>">
        ...
        <div class="ms-auto d-flex align-items-center">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="notificationDropdown" 
                    ...
                    <li class="dropdown-header bg-light py-2">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <?php if ($unreadNotifications > 0): ?>
                                <a href="<?= site_url('teachers/notifications/markAllRead') ?>" 
                    ...
                    <li>
                        <a class="dropdown-item text-center py-2" href="<?= site_url('teachers/notifications') ?>">
            ...
            <div class="dropdown">
                <a href="#" class="text-decoration-none d-flex align-items-center" data-bs-toggle="dropdown">
                    ...
                    <?php else: ?>
                        <img src="https://ui-avatars.com/api/?name=<?= urlencode(session()->get('name')) ?>&background=28a745&color=fff&size=40" 
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow">
                    <li>
                        <a class="dropdown-item" href="<?= site_url('teachers/profile') ?>">
                            <i class="fas fa-user-circle me-2"></i> Meu Perfil
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="<?= site_url('teachers/settings') ?>">
                            <i class="fas fa-cog me-2"></i> Configurações
                        </a>
                    </li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
                        <a class="dropdown-item text-danger" href="<?= site_url('teachers/auth/logout') ?>">
...
setInterval(function() {
    fetch('<?= site_url('teachers/notifications/getUnreadCount') ?>')
