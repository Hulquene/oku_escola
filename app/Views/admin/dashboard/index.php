...
<div class="ci-card mb-3">
    <div class="ci-card-header">
        <div class="ci-card-title">
            <i class="fa-solid fa-bolt text-accent"></i>Acções Rápidas
        </div>
    </div>
    <div class="ci-card-body">
        <div class="qa-grid">
            <?php if (can('students.create')): ?>
            <a href="<?= base_url('admin/students/create') ?>" class="qa-item">
                <div class="qa-icon ic-blue"><i class="fa-solid fa-user-plus"></i></div>
                <div class="qa-label">Novo Aluno</div>
                <div class="qa-sub">Cadastrar</div>
            </a>
            <?php endif; ?>

            <?php if (can('enrollments.create')): ?>
            <a href="<?= base_url('admin/enrollments/create') ?>" class="qa-item">
                <div class="qa-icon ic-green"><i class="fa-solid fa-id-card-clip"></i></div>
                <div class="qa-label">Matricular</div>
                <div class="qa-sub">Nova matrícula</div>
            </a>
            <?php endif; ?>

            <?php if (can('attendance.create')): ?>
            <a href="<?= base_url('admin/attendance') ?>" class="qa-item">
                <div class="qa-icon ic-teal"><i class="fa-solid fa-clipboard-user"></i></div>
                <div class="qa-label">Presenças</div>
                <div class="qa-sub">Registar</div>
            </a>
            <?php endif; ?>

            <?php if (can('exams.create')): ?>
            <a href="<?= base_url('admin/exams/create') ?>" class="qa-item">
                <div class="qa-icon ic-amber"><i class="fa-solid fa-file-pen"></i></div>
                <div class="qa-label">Exame</div>
                <div class="qa-sub">Agendar</div>
            </a>
            <?php endif; ?>

            <?php if (can('grades.add')): ?>
            <a href="<?= base_url('admin/grades') ?>" class="qa-item">
                <div class="qa-icon" style="background:rgba(124,77,255,.1);color:#7C4DFF"><i class="fa-solid fa-star-half-stroke"></i></div>
                <div class="qa-label">Notas</div>
                <div class="qa-sub">Lançar</div>
            </a>
            <?php endif; ?>

            <?php if (can('financial.payments')): ?>
            <a href="<?= base_url('admin/financial/payments/create') ?>" class="qa-item">
                <div class="qa-icon ic-green"><i class="fa-solid fa-hand-holding-dollar"></i></div>
                <div class="qa-label">Pagamento</div>
                <div class="qa-sub">Registar</div>
            </a>
            <?php endif; ?>

            <?php if (can('teachers.create')): ?>
            <a href="<?= base_url('admin/teachers/create') ?>" class="qa-item">
                <div class="qa-icon ic-teal"><i class="fa-solid fa-chalkboard-user"></i></div>
                <div class="qa-label">Professor</div>
                <div class="qa-sub">Cadastrar</div>
            </a>
            <?php endif; ?>

            <?php if (can('classes.create')): ?>
            <a href="<?= base_url('admin/classes/create') ?>" class="qa-item">
                <div class="qa-icon ic-slate"><i class="fa-solid fa-door-open"></i></div>
                <div class="qa-label">Turma</div>
                <div class="qa-sub">Criar</div>
            </a>
            <?php endif; ?>

            <?php if (can('reports.general')): ?>
            <a href="<?= base_url('admin/reports') ?>" class="qa-item">
                <div class="qa-icon ic-red"><i class="fa-solid fa-chart-bar"></i></div>
                <div class="qa-label">Relatórios</div>
                <div class="qa-sub">Gerar</div>
            </a>
            <?php endif; ?>

            <?php if (can('users.list')): ?>
            <a href="<?= base_url('admin/users') ?>" class="qa-item">
                <div class="qa-icon ic-slate"><i class="fa-solid fa-users-gear"></i></div>
                <div class="qa-label">Usuários</div>
                <div class="qa-sub">Gerir</div>
            </a>
            <?php endif; ?>

            <?php if (can('courses.list')): ?>
            <a href="<?= base_url('admin/courses') ?>" class="qa-item">
                <div class="qa-icon ic-amber"><i class="fa-solid fa-book-open"></i></div>
                <div class="qa-label">Cursos</div>
                <div class="qa-sub">Gerir</div>
            </a>
            <?php endif; ?>

            <?php if (can('settings.general')): ?>
            <a href="<?= base_url('admin/settings') ?>" class="qa-item">
                <div class="qa-icon ic-slate"><i class="fa-solid fa-gear"></i></div>
                <div class="qa-label">Definições</div>
                <div class="qa-sub">Sistema</div>
            </a>
            <?php endif; ?>
        </div>
    </div>
