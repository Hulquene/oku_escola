...
<style>
/* Reutilizar os mesmos estilos do CourseCurriculum */
...
.level-banner-info { display: flex; align-items: center; gap: 0.85rem; flex-wrap: wrap; }
.level-banner-icon {
...
.level-banner-name { font-weight: 700; font-size: 0.95rem; color: var(--text-primary); }
.level-banner-code {
...
.education-level-badge {
    background: rgba(59,127,232,0.1); color: var(--accent);
...
<div class="level-banner">
    ...
    <a href="<?= site_url('admin/grade-levels') ?>" class="btn-back">
...
<div class="curriculum-layout">
    ...
    <div class="levels-panel">
        <div class="levels-panel-header">
            <i class="fas fa-list" style="opacity:.7;"></i> Níveis de Ensino
        </div>
        <div class="levels-panel-body">
            <?php
            // Carregar contagem de disciplinas para cada nível
            $disciplineCounts = [];
        ...
        <div class="level-card">
            ...
            <?php if (!empty($disciplines)): ?>
                <div class="table-responsive">
                    <table class="ci-table">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="2" style="font-weight:700;color:var(--text-primary);">Carga Horária Total</td>
                                <td class="text-center"><span class="workload-chip total"><?= $totalWorkload ?>h</span></td>
                                <td colspan="3"></td>
                            </tr>
                        </tfoot>
                    </table>
            ...
            <?php else: ?>
                <div class="level-empty">
                    ...
                    <strong>Nenhuma disciplina configurada</strong>
                    <p>Clique em "Adicionar Disciplina" para definir as disciplinas deste nível de ensino.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <select id="discipline_id" name="discipline_id" required style="width:100%;">
                                <option value=""></option>
                                <?php
                                // Carregar helper se não estiver carregado automaticamente
                                helper('discipline');
                                
                                // Obter todas as disciplinas ativas
                                $allDisciplines = getAllDisciplines(true);
                                
                                // Se temos disciplinas já atribuídas, filtrar
                                if (isset($disciplines) && !empty($disciplines)) {
                                    $assignedIds = array_column($disciplines, 'discipline_id');
                                    $allDisciplines = getAvailableDisciplines(null, $assignedIds);
                                }
                        ...
                        <div class="col-sm-6">
                            <label class="form-label-ci" for="semester">Período</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p style="font-size:.875rem;margin-bottom:.75rem;">
                    Tem certeza que deseja remover <strong id="removeDisciplineName"></strong> deste nível?
                </p>
...
(function () {
    ...
    function showInfo(el) {
        ...
        document.getElementById('infoName').textContent = el.text;
    ...
    window.confirmRemoveDiscipline = function (id, name) {
        ...
        document.getElementById('confirmRemoveBtn').href =
            '<?= site_url('admin/grade-curriculum/remove/') ?>' + id;
