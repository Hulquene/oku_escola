...
<div class="ci-page-header mb-4">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="<?= site_url('admin/classes/levels') ?>">Níveis de Ensino</a></li>
            <li class="breadcrumb-item"><a href="<?= site_url('admin/grade-curriculum/' . $item->grade_level_id) ?>">Currículo</a></li>
...
<div class="form-card">
    <div class="form-card-header">
        <div class="form-card-header-title">
            ...
            Editar Disciplina no Nível de Ensino
        </div>
    </div>
    ...
    <div class="form-card-body">
        ...
        <div class="context-banner">
            <div class="ctx-item">
                <span class="ctx-label">Nível de Ensino</span>
            ...
            <div class="ctx-item">
                ...
                <span class="ctx-value">
                    <span class="ctx-code"><?= esc($item->level_code ?? '') ?></span>
                </span>
            </div>
            <div class="ctx-item">
        ...
        <!-- ── FORM ────────────────────────────────────── -->
        <form action="<?= site_url('admin/grade-curriculum/update/' . $item->id) ?>" method="post" id="editForm">
            <?= csrf_field() ?>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-sm-6">
                        ...
                        <select class="form-select-ci <?= session('errors.semester') ? 'is-invalid' : '' ?>"
                            ...
                            <option value="1º Semestre" <?= old('semester', $item->semester) == '1º Semestre' ? 'selected' : '' ?>>1º Semestre</option>
                            <option value="2º Semestre" <?= old('semester', $item->semester) == '2º Semestre' ? 'selected' : '' ?>>2º Semestre</option>
                        </select>
            ...
            <div class="form-footer">
                <a href="<?= site_url('admin/grade-curriculum/' . $item->grade_level_id) ?>" class="btn-back">
