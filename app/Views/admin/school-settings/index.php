...
<div class="tab-content" id="settingsTabContent">
    ...
    <div class="tab-pane fade show active" id="general" role="tabpanel">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= site_url('admin/school-settings/save-general') ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="school_province" name="school_province" 
                                           value="<?= $settings['school_province'] ?? '' ?>">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="school_founding_year" name="school_founding_year" 
                                           value="<?= $settings['school_founding_year'] ?? date('Y') ?>">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="school_alt_phone" name="school_alt_phone" 
                                           value="<?= $settings['school_alt_phone'] ?? '' ?>">
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <?php if (!empty($settings['school_logo'])): ?>
                                        ...
                                        <div class="mb-3">
                                            <a href="<?= site_url('admin/school-settings/remove-logo') ?>" 
    ...
    <div class="tab-pane fade" id="academic" role="tabpanel">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= site_url('admin/school-settings/save-academic') ?>" method="post">
                    <?= csrf_field() ?>
                        ...
                        <div class="col-md-6">
                                    ...
                                    <?php if (!empty($academicYears)): ?>
                                        <?php foreach ($academicYears as $year): ?>
                                            <option value="<?= $year->id ?>" 
                                                <?= ($settings['current_academic_year'] ?? '') == $year->id ? 'selected' : '' ?>>
                                                <?= $year->year_name ?>
                                            </option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                ...
                                <select class="form-select" id="semester_id" name="semester_id" required>
                                    ...
                                    <?php if (!empty($semesters)): ?>
                                        <?php foreach ($semesters as $sem): ?>
                                            <option value="<?= $sem->id ?>" 
                                                <?= ($settings['current_semester'] ?? '') == $sem->id ? 'selected' : '' ?>>
                                                <?= $sem->semester_name ?>
                                            </option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="grading_system" name="grading_system" required>
                                    <option value="0-20" <?= ($settings['grading_system'] ?? '0-20') == '0-20' ? 'selected' : '' ?>>0 a 20 valores</option>
                                    <option value="0-100" <?= ($settings['grading_system'] ?? '') == '0-100' ? 'selected' : '' ?>>0 a 100%</option>
                                    <option value="A-F" <?= ($settings['grading_system'] ?? '') == 'A-F' ? 'selected' : '' ?>>A a F (Letras)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="min_grade" name="min_grade" 
                                               step="0.1" value="<?= $settings['min_grade'] ?? 0 ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="max_grade" name="max_grade" 
                                               step="0.1" value="<?= $settings['max_grade'] ?? 20 ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="approval_grade" name="approval_grade" 
                                               step="0.1" value="<?= $settings['approval_grade'] ?? 10 ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="attendance_threshold" name="attendance_threshold" 
                                           min="0" max="100" value="<?= $settings['attendance_threshold'] ?? 75 ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="enrollment_deadline" name="enrollment_deadline" 
                                       value="<?= $settings['enrollment_deadline'] ?? '' ?>">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="academic_calendar" name="academic_calendar">
                                    <option value="semester" <?= ($settings['academic_calendar'] ?? 'semester') == 'semester' ? 'selected' : '' ?>>Semestral</option>
                                    <option value="trimester" <?= ($settings['academic_calendar'] ?? '') == 'trimester' ? 'selected' : '' ?>>Trimestral</option>
                                </select>
                            </div>
                        </div>
                    </div>
    ...
    <div class="tab-pane fade" id="fees" role="tabpanel">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= site_url('admin/school-settings/save-fees') ?>" method="post">
                    <?= csrf_field() ?>
                        ...
                        <div class="col-md-6">
                                    ...
                                    <?php if (!empty($currencies)): ?>
                                        <?php foreach ($currencies as $currency): ?>
                                            <option value="<?= $currency->id ?>" 
                                                <?= ($settings['default_currency'] ?? '') == $currency->id ? 'selected' : '' ?>>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="late_fee_percentage" name="late_fee_percentage" 
                                                   step="0.1" min="0" max="100" value="<?= $settings['late_fee_percentage'] ?? 0 ?>">
                                            <span class="input-group-text">%</span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" id="discount_early_payment" name="discount_early_payment" 
                                                   step="0.1" min="0" max="100" value="<?= $settings['discount_early_payment'] ?? 0 ?>">
                                            <span class="input-group-text">%</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="payment_deadline_days" name="payment_deadline_days" 
                                       min="1" value="<?= $settings['payment_deadline_days'] ?? 30 ?>">
                            ...
                            <div class="card bg-light mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" id="enable_multiple_payments" name="enable_multiple_payments" value="1"
                                               <?= ($settings['enable_multiple_payments'] ?? 0) ? 'checked' : '' ?>>
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" id="enable_partial_payments" name="enable_partial_payments" value="1"
                                               <?= ($settings['enable_partial_payments'] ?? 0) ? 'checked' : '' ?>>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="enable_fines" name="enable_fines" value="1"
                                               <?= ($settings['enable_fines'] ?? 0) ? 'checked' : '' ?>>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    <button class="btn btn-outline-warning" onclick="return confirm('Esta ação limpará todos os caches. Continuar?')">
