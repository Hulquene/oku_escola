        ...
        <tbody>
            ...
            <?php foreach ($alunos as $aluno): ?>
                ...
                <tr>
                    ...
                    <td class="text-center"><strong><?= $mediasAluno['trimestres'][1]['MT'] ?? '—' ?></strong></td>
                    ...
                    <td class="text-center"><strong><?= $mediasAluno['trimestres'][2]['MT'] ?? '—' ?></strong></td>
                    ...
                    <td class="text-center"><strong><?= $mediasAluno['trimestres'][3]['MT'] ?? '—' ?></strong></td>
                    
                    <!-- MDF -->
                    <td class="text-center">
                        <?php if (($mediasAluno['MDF'] ?? '—') !== '—'): ?>
                            <strong class="<?= $mediasAluno['MDF'] >= 10 ? 'approved' : ($mediasAluno['MDF'] >= 7 ? 'appeal' : 'failed') ?>">
                                <?= $mediasAluno['MDF'] ?>
                            </strong>
                        <?php else: ?>
                            —
                    ...
                    <!-- Situação -->
                    <td class="text-center">
                        <?php if (isset($mediasAluno['situacao'])): ?>
                            <strong class="<?= $mediasAluno['situacaoClass'] == 'success' ? 'approved' : ($mediasAluno['situacaoClass'] == 'warning' ? 'appeal' : 'failed') ?>">
                                <?= $mediasAluno['situacao'] ?>
                            </strong>
                        <?php else: ?>
                            Pendente
                        <?php endif; ?>
