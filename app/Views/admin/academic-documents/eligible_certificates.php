...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h1><i class="fas fa-certificate me-2"></i><?= $title ?></h1>
...
<div class="filter-card">
    <form method="get" class="row g-3">
        ...
        <div class="col-md-8 text-end">
            <a href="<?= site_url('admin/academic-documents/eligible-declarations?academic_year=' . $academicYearId) ?>" class="btn btn-outline-primary">
                <i class="fas fa-file-alt me-1"></i> Ver Declarações
            </a>
        </div>
    </form>
</div>
...
<div class="row mb-4">
    <div class="col-md-6">
        <div class="stats-card">
            ...
            <div class="stats-number"><?= count(array_filter($students, function($s) { return !$s['certificate_issued']; })) ?></div>
...
<div class="alert alert-info">
    ...
    Nenhum aluno apto para certificado encontrado no ano letivo selecionado.
</div>
<?php else: ?>
<div class="table-container">
    <div class="table-header">
        <i class="fas fa-list me-2"></i> Alunos Aptos para Certificado
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <?php if (!empty($student['course_name'])): ?>
                            <span class="badge-info"><?= $student['course_name'] ?></span>
                        <?php else: ?>
                            <span class="badge-success"><?= $student['education_level'] ?></span>
                        <?php endif; ?>
                    </td>
                    ...
                    <td class="text-center">
                        <?php if (!$student['certificate_issued']): ?>
                            <a href="<?= site_url('admin/academic-documents/generate-certificate/' . $student['enrollment_id']) ?>" 
                               class="btn-generate"
                               onclick="return confirm('Gerar certificado para <?= $student['first_name'] ?> <?= $student['last_name'] ?>?')">
                                <i class="fas fa-certificate"></i> Gerar
                            </a>
                        <?php else: ?>
                            <span class="badge-success">
                                <i class="fas fa-check"></i> Nº: <?= $student['certificate_number'] ?>
                            </span>
                        <?php endif; ?>
                    </td>
                </tr>
